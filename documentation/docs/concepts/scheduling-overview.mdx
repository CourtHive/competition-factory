...
In [CODES](/docs/data-standards#codes), scheduling information is attached to matchUps as `timeItems` rather than stored in a centralized schedule object. This decentralized approach provides several advantages:
...
- **[Venues and Courts](./venues-courts.md)** - Setting up tournament venues
- **[Scheduling Profile](./scheduling-profile.mdx)** - Multi-day scheduling configuration
- **[Automated Scheduling](./automated-scheduling.md)** - Algorithm details and pseudocode
- **[Pro Scheduling](./pro-scheduling.md)** - Grid-based and Follow By scheduling
- **[Conflict Reporting](./scheduling-conflicts.mdx)** - Detecting and resolving conflicts
- **[Scheduling Policy](./scheduling-policy.mdx)** - Configuring timing and constraints
