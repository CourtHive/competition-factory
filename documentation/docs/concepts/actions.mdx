...
- **[Draw Generation](./draws-overview.mdx)** - Creating draws with participant assignments
...
- **[Scheduling Overview](./scheduling-overview.mdx)** - Understanding match scheduling
- **[Team Events](./tieFormat.mdx)** - Lineup and substitution management
