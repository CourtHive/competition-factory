...
**See:** [Scale Items](./scaleItems.md) for detailed scale item documentation.
...
- **[Scale Items](./scaleItems.md)** - Using accessors with scale values
- **[Participants](./participants.md)** - Participant data structure
