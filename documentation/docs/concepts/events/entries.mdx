...
If you need to separate participants by skill level, use [flight profiles](./flights.mdx) rather than duplicating entries across multiple draws.
...
**API Reference:** [modifyEventEntries](/docs/governors/entries-governor#modifyevententries)
...
- [Categories](./categories.mdx) - Event eligibility criteria and age calculation
- [Flights](./flights.mdx) - Automatic participant segmentation
