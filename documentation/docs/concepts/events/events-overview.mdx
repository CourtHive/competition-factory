...
- **category** - Category definition (see [Categories](./categories.mdx))
- **entries** - Array of participant entries (see [Entries](./entries.mdx))
...
- See [Tie Formats](../tieFormat.mdx) for details
...
- [Categories](./categories.mdx) - Define eligibility and characteristics
- [Entries](./entries.mdx) - Manage participant entries
- [Flights](./flights.mdx) - Automatic skill-based segmentation
