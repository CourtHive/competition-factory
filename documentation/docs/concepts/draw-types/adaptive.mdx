...
An **Adaptive** draw combines the multi-structure topology of a [Compass](./compass.mdx) draw with the flexible sizing of a [Lucky Draw](./lucky-draw.mdx). Where Compass requires power-of-2 draw sizes, Adaptive supports any participant count (e.g., 11, 18, 22) across a full direction cascade.
...
- [Compass Draw](./compass.mdx) -- Power-of-2 variant with standard elimination
- [Lucky Draw](./lucky-draw.mdx) -- Single-structure lucky draw logic
- [Olympic Draw](./olympic.mdx) -- Smaller variant guaranteeing 2 matchUps
- [Draw Links](../draw-links.mdx) -- How losers flow between structures
