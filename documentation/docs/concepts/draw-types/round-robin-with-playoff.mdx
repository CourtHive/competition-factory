...
- [Round Robin](./round-robin.md) -- Group play without playoffs
- [Finishing Positions](../finishing-positions.md) -- How finishing positions propagate through linked structures
- [Draw Links](../draw-links.mdx) -- How position-based links connect groups to playoffs
