...
- [Feed-In Draw](./feed-in.md) -- The standalone feed-in structure
- [Double Elimination](./double-elimination.mdx) -- Main + consolation where consolation winner plays main winner
- [Draw Links](../draw-links.mdx) -- How loser links connect main and consolation structures
