...
- [Adaptive Draw](./adaptive.mdx) -- Multi-structure variant using lucky draw logic for any participant count
- [Draw Types Overview](../draw-types.md) -- List of all pre-defined draw types
- [Single Elimination](./single-elimination.md) -- Standard power-of-2 knockout draw
- [Draw Links](../draw-links.mdx) -- How structures connect in multi-structure draws
