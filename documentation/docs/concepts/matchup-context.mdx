...
```js
{
  ...
  // Finishing position ranges (see Finishing Positions concept)
...
See [Finishing Positions](./finishing-positions.md) for a full explanation of how `finishingPositionRange` is computed across draw types and how the accessor maps to ranking policy keys.
...
**See:** [Participant Context](./participant-context.md) for participant hydration options.
...
**See:** [Extensions](./extensions.md) for detailed extension documentation.
...
**See:** [Participant Context](./participant-context.md) for complete hydration options.
...
- **[MatchUp Overview](./matchup-overview.md)** - Core matchUp concepts and types
- **[MatchUp Filtering](./matchup-filtering.mdx)** - Comprehensive filtering options
- **[Participant Context](./participant-context.md)** - Participant hydration details
- **[Extensions](./extensions.md)** - Custom data and extensions
