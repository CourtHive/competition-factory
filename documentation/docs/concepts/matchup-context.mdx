...
See [Finishing Positions](./finishing-positions) for a full explanation of how `finishingPositionRange` is computed across draw types and how the accessor maps to ranking policy keys.
