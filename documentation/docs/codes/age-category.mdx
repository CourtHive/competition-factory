...
Age category codes may appear on an attribute of a [`category`](../types/typedefs.mdx#generic), which can appear in `event` and `drawDefinition` elements within a tournament record.
...
Age category codes follow [CODES](/docs/data-standards#codes) standards and support several formats:
