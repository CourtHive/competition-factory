...
import { participantRoles as participantRolesObject } from './participantRoles';
...
// participantRoles is hand-authored rather than generated by scripts/generateEnumConstants, so unlike the
// five above its namespace CAN lag the enum — which is the direction this pair of guards was missing when
// SCOREKEEPER and TIMEKEEPER reached the const module but not the enum.
export type _KeysParticipantRole = Assert<KeysMirrored<typeof ParticipantRoleEnum, typeof participantRolesConstants>>;
...
export type _ValuesParticipantRole = Assert<
  ValuesMirrored<typeof ParticipantRoleEnum, typeof participantRolesConstants>
>;
...
export type _ObjectParticipantRole = Assert<KeysMirrored<typeof ParticipantRoleEnum, typeof participantRolesObject>>;
