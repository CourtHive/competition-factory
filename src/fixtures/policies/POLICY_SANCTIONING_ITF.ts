  ...
  tiers: [
    {
      ...
      minimumPrizeMoney: { amount: 15000, currencyCode: 'USD', unit: 'MAJOR' },
      maximumPrizeMoney: { amount: 24999, currencyCode: 'USD', unit: 'MAJOR' },
      currencyCode: 'USD',
      minimumCourts: 4,
      minimumOfficials: 2,
    ...
    },
    {
      ...
      qualifyingAllowed: true,
      maxQualifyingDrawSize: 32,
      minimumPrizeMoney: { amount: 25000, currencyCode: 'USD', unit: 'MAJOR' },
      maximumPrizeMoney: { amount: 34999, currencyCode: 'USD', unit: 'MAJOR' },
      currencyCode: 'USD',
      minimumCourts: 5,
      minimumOfficials: 3,
      officialCertificationLevel: WHITE_BADGE,
    ...
    },
    {
      ...
      qualifyingAllowed: true,
      maxQualifyingDrawSize: 32,
      minimumPrizeMoney: { amount: 35000, currencyCode: 'USD', unit: 'MAJOR' },
      maximumPrizeMoney: { amount: 49999, currencyCode: 'USD', unit: 'MAJOR' },
      currencyCode: 'USD',
      minimumCourts: 5,
      minimumOfficials: 3,
      officialCertificationLevel: WHITE_BADGE,
    ...
    },
    {
      ...
      qualifyingAllowed: true,
      maxQualifyingDrawSize: 32,
      minimumPrizeMoney: { amount: 50000, currencyCode: 'USD', unit: 'MAJOR' },
      maximumPrizeMoney: { amount: 74999, currencyCode: 'USD', unit: 'MAJOR' },
      currencyCode: 'USD',
      minimumCourts: 6,
      minimumOfficials: 4,
    ...
    },
    {
      ...
      qualifyingAllowed: true,
      maxQualifyingDrawSize: 32,
      minimumPrizeMoney: { amount: 75000, currencyCode: 'USD', unit: 'MAJOR' },
      maximumPrizeMoney: { amount: 99999, currencyCode: 'USD', unit: 'MAJOR' },
      currencyCode: 'USD',
      minimumCourts: 8,
      minimumOfficials: 5,
      officialCertificationLevel: 'Bronze Badge',
    ...
    },
    {
      ...
      qualifyingAllowed: true,
      maxQualifyingDrawSize: 32,
      minimumPrizeMoney: { amount: 100000, currencyCode: 'USD', unit: 'MAJOR' },
      currencyCode: 'USD',
      minimumCourts: 10,
      minimumOfficials: 6,
