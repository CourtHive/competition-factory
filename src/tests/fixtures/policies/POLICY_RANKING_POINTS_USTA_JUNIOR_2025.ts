/**
 * USTA Junior Tournaments Ranking System — 2025 Edition
 *
...
//
// Cross-category aggregation (per jr-ranking-system-2025.pdf):
//   - Downward 20% carry — results in the next-younger age category contribute
//     at 20% to the older category's list (12U→14U, 14U→16U, 16U→18U).
//   - Upward play-up — results in the next-older age category contribute at
//     100% to the younger category's list, but only for participants who have
//     at least one direct result in the younger category
...
const aggregationRules = {
  ...
  categoryAggregation: [
    // Downward 20% — unconditional next-older carry
    {
      ruleName: '12U → 14U (20%)',
    ...
    // Upward play-up — full carry with participation requirement
    {
      ruleName: '14U play-up → 12U',
      source: { ageCategoryCodes: ['14U'] },
...
export const POLICY_RANKING_POINTS_USTA_JUNIOR_2025 = {
  [POLICY_TYPE_RANKING_POINTS]: {
    policyName: 'USTA Junior 2025',
    policyVersion: '2025.01',
    validDateRange: { startDate: '2025-01-01', endDate: '2025-12-31' },
...
export default POLICY_RANKING_POINTS_USTA_JUNIOR_2025;
